...
namespace NGLB_SERVICES.Controllers
{
    ...
    public class DestinyController : ApiController
    {
        ...
        [ResponseType(typeof(List<SearchPlayerResult>))]
        [HttpGet]
        public async Task<JsonResult<List<SearchPlayerResult>>> SearchPlayer(string apiKey, string player)
        {
            ...
            { 
                    ...
                    List<SearchPlayerResult> list = await service.PlayerSearchListAsync(player);
